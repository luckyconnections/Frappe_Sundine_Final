...
$.extend(frappe.desktop, {
	...
	render: function() {
		...
		var explore_icon1 = {
			module_name: 'Driver Location',
			label: 'Driver Location',
			_label: __('Driver Location'),
			_id: 'Driver Location',
			_doctype: '',
			icon: 'octicon octicon-location',
			color: '#7578f6',
			link:'/driver_location'
		};
		
		explore_icon.app_icon = frappe.ui.app_icon.get_html(explore_icon);
		all_icons.push(explore_icon);
		var explore_icon1 = {
			module_name: 'Sale Route Map',
			label: 'Sale Route Map',
			_label: __('Sale Route Map'),
			_id: 'Sale Route Map',
			_doctype: '',
			icon: 'octicon octicon-location',
			color: '#7578f6',
		...
		explore_icon1.app_icon = frappe.ui.app_icon.get_html(explore_icon1);
		all_icons.push(explore_icon1);
		var explore_icon2 = {
